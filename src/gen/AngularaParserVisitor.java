...
public interface AngularaParserVisitor<T> extends ParseTreeVisitor<T> {
	 ...
	 * @return the visitor result
	 */
	T visitImportStmt(AngularaParser.ImportStmtContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitComponentStmt(AngularaParser.ComponentStmtContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitDecoratorStmt(AngularaParser.DecoratorStmtContext ctx);
	/**
	 * Visit a parse tree produced by the {@code ExportStmt}
	 * labeled alternative in {@link AngularaParser#statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitExportStmt(AngularaParser.ExportStmtContext ctx);
	/**
	 * Visit a parse tree produced by the {@code ExportDefaultStmt}
	 * labeled alternative in {@link AngularaParser#statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitExportDefaultStmt(AngularaParser.ExportDefaultStmtContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitClassStmt(AngularaParser.ClassStmtContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitVarStmt(AngularaParser.VarStmtContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitExprStmt(AngularaParser.ExprStmtContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitMethodStmt(AngularaParser.MethodStmtContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitIfStmt(AngularaParser.IfStmtContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitInterfaceStmt(AngularaParser.InterfaceStmtContext ctx);
	/**
