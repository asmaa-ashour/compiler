...
statement
    ...
    | decorator exportStatement        # DecoratorStmt
...
componentMetadataProperty
    : SELECTOR COLON STRING               #selector
    | STANDALONE COLON BOOLEAN_LITERAL    #standalone
    | IMPORTS COLON value                 #imports
    | TEMPLATE COLON TEMPLATE_STR         #template
    | STYLE_URLS COLON arrayLiteral       #styleUrls
    | IDENTIFIER COLON value              #customProperty
    ;
